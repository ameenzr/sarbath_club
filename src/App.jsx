...
function Game({ onGames }) {
  ...
  return <Shell className="game-site"><main className={`game-layout${showingCoupon ? ' coupon-page' : ''}`}>{!showingCoupon && <button className="back-to-games" onClick={onGames}><span aria-hidden="true">&lt;</span>All games</button>}{showGameIntro && <section className="intro"><span className="eyebrow">REACTION GAME</span><h1>Tap fast.<br /><span>Sip free.</span></h1><div className="game-lede"><p>Wait for blue, then tap anywhere.</p><p>Win first. Enter your details after.</p></div></section>}<section className="game-card" aria-live="polite">
